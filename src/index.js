      ...
      switch (_lang) {
          ...
          case 'zh-SG':
              config = {
                  ...
                  bindFunctionKey: '绑定工具栏唤出功能键，按住功能键单击鼠标右键可立即唤出当前分组的磁贴',
                  ctrlKey: 'Ctrl键',
                  altKey: 'Alt键',
                  shiftKey: 'Shift键',
                  metaKey: 'meta键',
          ...
          case 'zh-HK':
              config = {
                  ...
                  bindFunctionKey: '綁定工具欄喚出配合功能鍵，按住功能鍵單擊滑鼠右鍵可立即喚出當前分組的磁貼',
                  ctrlKey: 'Ctrl鍵',
                  altKey: 'Alt鍵',
                  shiftKey: 'Shift鍵',
                  metaKey: 'meta鍵',
          ...
          default:
              config = {
                  ...
                  bindFunctionKey: 'Bind function key for right mouse to call out toolbar, then you can click to call out search tiles without long press',
                  ctrlKey: 'Ctrl key',
                  altKey: 'Alt key',
                  shiftKey: 'Shift key',
                  metaKey: 'Meta key',
                  ...
                  dragToSearchTips: 'Drag text, link or image to search quickly, the inner circle contains the top 6 sites in the current category(first txt/img/link group), and the outer circle contains the most recently used sites',
