      ...
      switch (_lang) {
          ...
          case 'zh-SG':
              config = {
                  ...
                  groupName: '集合名',
                  donate: '💞我是 SearchJumper 的作者 Hoothin。 SearchJumper 是完全免费的，尽管它已经花费了我大量的时间来开发。 如果您发现 SearchJumper 很有价值，那么请考虑通过以下方式之一夸夸我，以勉励我继续维护',
          ...
          case 'zh-HK':
              config = {
                  ...
                  groupName: '集合名',
                  donate: '💞我是 SearchJumper 的作者 Hoothin。 SearchJumper 是完全免費的，儘管它已經花費了我大量的時間來開發。如果您發現 SearchJumper 很有價值，那麼請考慮通過以下方式之一誇誇我，以勉勵我繼續維護',
          ...
          default:
              config = {
                  ...
                  donate: '💞Hi, I\'m Hoothin, the author of SearchJumper. SearchJumper is completely free, even though it has taken a lot of work to develop. If you have found SearchJumper valuable, then please consider helping me out in one of the following ways.',
