      ...
      switch (_lang) {
          ...
          case 'zh-SG':
              config = {
                  ...
                  kwFilter: '筛选正则',
                  kwFilterTips: '搜索词或者指向链接的筛选正则，当对象文字或者链接不匹配时隐藏该引擎',
                  siteMatch: '网址匹配',
                  ...
                  initShow: '默认拉出工具栏',
                  initShowTips: '默认拉出工具栏，鼠标划过后再贴边隐藏',
                  configPage: '默认设置页',
          ...
          case 'zh-HK':
              config = {
                  ...
                  kwFilter: '篩選正則',
                  kwFilterTips: '搜尋詞或者指向連結的篩選正則，當對象文字或者連結不匹配時隱藏該引擎',
                  siteMatch: '網址匹配',
                  ...
                  initShow: '默認拉出工具欄',
                  initShowTips: '預設立即拉出工具欄，鼠標划過后再貼邊隱藏',
                  configPage: '預設設定頁',
          ...
          case 'ru':
              config = {
                  ...
                  mouseLeaveToHide: 'Прятать Toolbar меню автоматически',
                  mouseLeaveToHideTips: 'Toolbar меню скрывается автоматически, если убрать курсор',
                  ...
                  kwFilterTips: 'Filter search keywords or url, Hide the engine when the object words or target url does not match this regex',
                  siteMatch: 'Match URL',
                  ...
                  alwaysShow: 'Всегда отображать Toolbar меню',
                  alwaysShowTips: 'Toolbar меню всегда отображается на странице послее ее загрузки',
                  ...
                  enableInInput: 'Включить при вводе', //????????????????????????????????????????????????????????????
                  ...
                  hideTileType: 'Скрыть иконку группы во PopUp меню',
                  ...
                  autoHideTips: 'Свернуть Toolbar меню автоматически после временной задержки, установленной выше',
                  ...
                  targetTxt: 'Поиск по словам',
                  targetImg: 'Поиск по картинке',
                  targetLink: 'Поиск по ссылке',
                  ...
                  minPopupInput: 'Только при вводе', // ???????????????????????????????????????????????????????????????????????????????????????????????????????????
          ...
          default:
              config = {
                  ...
                  alwaysShowTips: 'Show toolbar even if no engine matches',
                  ...
                  hideOnSearchEngineTips: 'Don\'t show toolBar on engine page',
