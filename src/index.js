...
switch (lang) {
    ...
    case 'zh-SG':
        config = {
            ...
            bindFunctionKey: '绑定工具栏唤出功能键，按住功能键单击鼠标即可',
            ctrlKey: 'Ctrl键',
            altKey: 'Alt键',
            shiftKey: 'Shift键',
            metaKey: 'meta键',
            ...
            minSizeMode: '极简模式',
            minSizeModeTips: '开启后，搜索条将只显示当前分类，直至鼠标划过',
            dragToSearch: '开启拖拽搜索',
    ...
    case 'zh-HK':
        config = {
            ...
            bindFunctionKey: '綁定工具欄喚出配合功能鍵，按住功能鍵單擊滑鼠即可',
            ctrlKey: 'Ctrl鍵',
            altKey: 'Alt鍵',
            shiftKey: 'Shift鍵',
            metaKey: 'meta鍵',
            ...
            minSizeMode: '極簡模式',
            minSizeModeTips: '開啟後，搜索條將只顯示當前分類，直至鼠標劃過',
            dragToSearch: '開啟拖拽搜索',
    ...
    default:
        config = {
            ...
            bindFunctionKey: 'Bind function key for mouse to call out toolbar, then click to call out without long press',
            ctrlKey: 'Ctrl key',
            altKey: 'Alt key',
            shiftKey: 'Shift key',
            metaKey: 'Meta key',
