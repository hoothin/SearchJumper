# [SearchJumper](https://greasyfork.org/scripts/445274-searchjumper "搜索酱 搜尋醬 検索ちゃん Install from greasyfork")  [👆Seek more search engines 更多引擎](https://github.com/hoothin/SearchJumper/issues?q=label%3A%22Sites+Rule%22)
