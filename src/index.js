      ...
      switch (_lang) {
          ...
          case 'ja':
              config = {
                  ...
                  typeMatch: '現在のグループを URL でフィルターし、0 に設定して非表示にします',
                  ...
                  kwFilter: '検索キーワードまたは URL をフィルタリング',
                  kwFilterTips: 'オブジェクトの単語またはターゲット URL がこの正規表現と一致しない場合、エンジンを非表示にします',
                  siteMatch: 'マッチング エンジンのサイトの URL RegExp、0 に設定して強制的に非表示',
                  siteCharset: '文字セット',
                  ...
                  typeMatchTips: 'URL が一致する場合にのみこのカテゴリを表示',
                  ...
                  shareText: '私の SearchJumper エンジン: https://search.hoothin.com/#t# パスワード: #t#',
                  shareTips: '共有ページ: ',
                  ...
                  param_u: '現在のウェブサイトの URL は、リンクまたは画像を指す場合、対応する URL を意味します。 %U: encodeURIComponent を使用',
                  param_h: '現在のウェブサイトホスト',
                  param_t: 'ターゲットのリンクまたは画像のアドレス。 %T: encodeURIComponent を使用',
          ...
          default:
              config = {
                  ...
                  rulesStore: 'Search engine storage',
