      ...
      switch (_lang) {
          ...
          case 'zh-SG':
              config = {
                  ...
                  param_su: '大写字母搜索词',
                  param_sr: '未转码的搜索关键词',
                  param_ss: '搜索关键词转换为简体中文，需要安装我的【简繁自由切换】',
                  param_st: '搜索关键词转换为繁体中文，需要安装我的【简繁自由切换】',
                  param_e: '当前页面编码',
                  ...
                  param_ssplit: '多行搜索参数，%s[]代表按换行或者空格分隔后依次取下一项，%s[-1]代表逆序依次取下一项，%s[0]代表指定第一项，%s[1|@]代表以@分隔并且指定第二项，支持replace，例如%s[].replace(/(\\d)/,"a$1")。没有关键词时会尝试读取剪贴板',
          ...
          case 'zh-HK':
              config = {
                  ...
                  param_su: '大寫字母搜尋詞',
                  param_sr: '未轉碼的搜尋關鍵詞',
                  param_ss: '搜尋關鍵詞轉換爲簡體中文，需要安裝我的【繁簡自由切換】',
                  param_st: '搜尋關鍵詞轉換爲正體中文，需要安裝我的【繁簡自由切換】',
                  param_e: '當前頁面編碼',
                  ...
                  param_ssplit: '多行搜索参数，%s[]代表按换行或者空格分隔后依次取下一项，%s[-1]代表逆序依次取下一项，%s[0]代表指定第一项，%s[1|@]代表以@分隔并且指定第二项，支持replace，例如%s[].replace(/(\\d)/,"a$1")。沒有關鍵詞時會嘗試讀取剪貼板',
          ...
          default:
              config = {
                  ...
                  param_ss: 'Search keyword to Simplified Chinese, need to work with my 【Switch Traditional Chinese and Simplified Chinese】',
                  param_st: 'Search keyword to Traditional Chinese, need to work with my 【Switch Traditional Chinese and Simplified Chinese】',
                  param_e: 'Charset',
