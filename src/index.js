...
switch (lang) {
    ...
    case 'zh-SG':
        config = {
            ...
            bindFunctionKey: '绑定工具栏唤出功能键，按住功能键单击鼠标即可唤出当前分类的磁贴',
            ctrlKey: 'Ctrl键',
            altKey: 'Alt键',
            shiftKey: 'Shift键',
            metaKey: 'meta键',
            ...
            expandType: '展开类别',
            expandTypeTips: '不隐藏同一类别中超出10个之外的站点',
            ...
            keywordRegTips: '单个关键词：wd；多个关键词：wd|qw|key；正则分组：(?:wd|w)=(.*?)(&|$)',
    ...
    case 'zh-HK':
        config = {
            ...
            disableInputOnWordsTips: '在劃選文字時使用快捷鍵不彈出搜尋輸入框',
            inPageRule: '站點自動高亮規則',
            errorNoType: '請輸入類別名',
            ...
            bindFunctionKey: '綁定工具欄喚出配合功能鍵，按住功能鍵單擊滑鼠即可喚出當前分類的磁貼',
            ctrlKey: 'Ctrl鍵',
            altKey: 'Alt鍵',
            shiftKey: 'Shift鍵',
            metaKey: 'meta鍵',
            ...
            autoCloseTips: '啟用之後一旦滑鼠離開搜尋條，已打開的類別抽屜將會自動合上',
            ...
            minSizeMode: '極簡模式',
            minSizeModeTips: '開啟後，搜尋條將只顯示當前分類，直至鼠標劃過',
            dragToSearch: '開啟拖拽搜尋',
            dragToSearchTips: '開啟後拖拽文字、連結或者圖片進行搜尋，內圈為當前分類前6個站點，外圈為最近使用的站點',
            ...
            expandType: '展開類別',
            expandTypeTips: '不隱藏同一類別中超出10個之外的站點',
            jsonToolong: '站點數據過於龐大，是否繼續格式化為JSON文本？',
            cacheSwitchTips: '瀏覽網頁時在後台緩存圖標為base64圖片，注意開啟後會彈出跨域請求',
            searchFontawesome: '🚩 搜尋 FontAwesome 圖標用於類別項',
            keywordRegTips: '單個關鍵詞：wd；多個關鍵詞：wd|qw|key；正則分組：(?:wd|w)=(.*?)(&|$)',
            ...
            disableAutoOpenTips: '啓用後，調出搜尋條之後，對應類別將不再自動展開',
            minPopup: '最小化搜尋彈框',
