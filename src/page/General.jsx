...
export default function General() {
    ...
    if (!window.searchData.prefConfig.tilesZoom) {
        window.searchData.prefConfig.tilesZoom = 100;
    }
    if (!window.searchData.prefConfig.tipsZoom) {
        window.searchData.prefConfig.tipsZoom = 100;
    }
    ...
    return (
        <Box sx={{paddingBottom: '20px'}}>
            ...
            <Accordion elevation={5} sx={{ padding: '10px', borderRadius: '4px', marginBottom: '20px' }}>
                ...
                <AccordionDetails>
                    <Typography gutterBottom component="div" sx={{ display: state.configPage === window.location.href ? 'none' : '' }}>
                        <h4>{window.i18n('configPage')}</h4>
                    </Typography>
                    <FormControl sx={{ m: 1, minWidth: 80, width: '100%', mb: '20px', display: state.configPage === window.location.href ? 'none' : '' }}>
                        <FormControlLabel
                            control={
