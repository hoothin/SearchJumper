...
switch (lang) {
    ...
    case 'zh-SG':
        config = {
            ...
            altToHightlight: 'Alt 划选立即高亮',
            altToHightlightTips: '使用页内搜索功能时使用 Alt 划选后立即高亮',
            inPageRule: '站点自动高亮规则',
            errorNoType: '请输入类别名',
    ...
    case 'zh-HK':
        config = {
            ...
            altToHightlight: 'Alt 劃選立即高亮',
            altToHightlightTips: '使用頁內搜索功能時使用 Alt 劃選後立即高亮',
            inPageRule: '站點自動高亮規則',
            errorNoType: '請輸入類別名',
    ...
    default:
        config = {
            ...
            altToHightlight: 'Alt swipe to highlight immediately',
            altToHightlightTips: 'When using the in-page search function, use Alt to highlight immediately after selection',
